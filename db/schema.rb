...
ActiveRecord::Schema.define(version: 2021_04_18_224434) do
  ...
  create_table "comment_highlights", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["comment_id", "highlight_id"], name: "index_comment_highlights_on_comment_id_and_highlight_id", unique: true
  end
